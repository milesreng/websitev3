      ...
      <div className='w-11/12 mx-auto mt-8 border-2 border-white text-gunmetal-500  bg-default-bg bg-opacity-80 rounded-md'>
        <div className='w-5/6 mx-auto py-8'>
          <form className='w-full flex flex-col gap-8' onSubmit={handleSubmit}>
            ...
            <button type='submit' className=' bg-gunmetal-50 text-gunmetal rounded-md w-1/2 md:w-1/4 lg:w-1/6 text-md lg:text-xl mx-auto py-1 hover:bg-gunmetal-100 transition duration-200 uppercase font-header'>Submit</button>
          </form>
        </div>
      </div>
    </div>
