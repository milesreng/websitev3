    ...
    render() {
        return (
            <div className="h-full flex flex-col justify-around">
                <div className="flex flex-col lg:flex-row lg:gap-4 text-white w-11/12 items-center lg:h-full my-auto">
                    <div className="block lg:hidden w-3/4 sm:w-1/2 border-white border-4 rounded-full my-auto">
                        <img className="overflow-hidden rounded-full"   
                            src={headshot} alt="Miles in a suit smiling" />
                    </div>
                    <h3 className="text-2xl sm:text-3xl lg:text-4xl text-center lg:text-right mt-8 sm:mt-24 lg:mt-0 w-11/12 md:w-3/4 lg:pl-20 md:pr-8">Hi! I'm Miles Eng, a junior 
